...
import com.onevizion.uitest.api.helper.entity.EntityAnnouncement;
...
public abstract class AbstractSeleniumCore extends AbstractTestNGSpringContextTests {
    ...
    @Autowired
    protected EntityAnnouncement entityAnnouncement;
    /* Entity Helpers End */
    ...
    public static final String LOADING_PREVIEW_ID_BASE = "loaderpreview";
