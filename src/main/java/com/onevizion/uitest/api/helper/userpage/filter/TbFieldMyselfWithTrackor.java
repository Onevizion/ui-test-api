...
@Component
public class TbFieldMyselfWithTrackor {
    ...
    public void test(String columnId, String trackorColumnId, List<String> trackors) {
        ...
        userpageFilter.checkFilterEqualMyselfWithTrackor(fieldName, trackorFieldName, trackorCellVals, trackors);
        userpageFilter.checkFilterNotEqualMyselfWithTrackor(fieldName, trackorFieldName, trackorCellVals, trackors);
    }
