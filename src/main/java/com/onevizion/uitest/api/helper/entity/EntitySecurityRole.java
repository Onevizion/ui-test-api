...
public class EntitySecurityRole {
    ...
    private static final String DEF_PRIV_CONFIGURED_APPLET_R = "cbPrivR2";
    private static final String DEF_PRIV_CONFIGURED_APPLET_E = "cbPrivE2";
    private static final String DEF_PRIV_CONFIGURED_TAB_R = "cbPrivR3";
    private static final String DEF_PRIV_CONFIGURED_TAB_E = "cbPrivE3";
    ...
    public void add(SecurityRole securityRole) {
        ...
        setCheckboxValue(securityRole.getDefaultPrivs().getConfiguredAppletR(), DEF_PRIV_CONFIGURED_APPLET_R);
        setCheckboxValue(securityRole.getDefaultPrivs().getConfiguredAppletE(), DEF_PRIV_CONFIGURED_APPLET_E);
        setCheckboxValue(securityRole.getDefaultPrivs().getConfiguredTabR(), DEF_PRIV_CONFIGURED_TAB_R);
        setCheckboxValue(securityRole.getDefaultPrivs().getConfiguredTabE(), DEF_PRIV_CONFIGURED_TAB_E);
    ...
    public void testOnForm(SecurityRole securityRole) {
        ...
        assertElement.assertCheckbox(DEF_PRIV_CONFIGURED_APPLET_R, securityRole.getDefaultPrivs().getConfiguredAppletR());
        assertElement.assertCheckbox(DEF_PRIV_CONFIGURED_APPLET_E, securityRole.getDefaultPrivs().getConfiguredAppletE());
        assertElement.assertCheckbox(DEF_PRIV_CONFIGURED_TAB_R, securityRole.getDefaultPrivs().getConfiguredTabR());
        assertElement.assertCheckbox(DEF_PRIV_CONFIGURED_TAB_E, securityRole.getDefaultPrivs().getConfiguredTabE());
