...
/**
 * @deprecated (we should use methods from specialized helpers: Menu, Dashboard, Portal, ComponentPackage)
 */
@Deprecated
@Component
public class NewDropDown { //TODO need to remove this file and rename NewNewDropDown.java to NewDropDown.java?
