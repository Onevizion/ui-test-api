...
public class TbMultiTrackorSelectorField {
    ...
    public void test(String columnId, String value, List<String> newTrackors, List<String> oldTrackors) {
        ...
        userpageFilter.checkFilter(fieldName, value, null, FilterOperatorType.EQUAL, ConfigFieldType.MULTI_TRACKOR_SELECTOR, columnIndex, cellVals);
        userpageFilter.checkFilter(fieldName, value, null, FilterOperatorType.NOT_EQUAL, ConfigFieldType.MULTI_TRACKOR_SELECTOR, columnIndex, cellVals);
        userpageFilter.checkFilter(fieldName, value, null, FilterOperatorType.NULL, ConfigFieldType.MULTI_TRACKOR_SELECTOR, columnIndex, cellVals);
        userpageFilter.checkFilter(fieldName, value, null, FilterOperatorType.NOT_NULL, ConfigFieldType.MULTI_TRACKOR_SELECTOR, columnIndex, cellVals);
