...
public class TbDropDownField {
    ...
    public void test(String columnId, String columnId2, String value, boolean supportOuterOperations, boolean supportFieldOperations, List<String> ... cellValsKeys) {
        ...
        if (supportOuterOperations && supportFieldOperations) {
            userFilterHelper.checkFilterOperators(fieldName, null, Arrays.asList("=", "(+)=", "<>", "(+)<>", "Is Null", "Is Not Null", "=Field", "<>Field"));
        ...
        userFilterHelper.checkFilterAttributeAndOperatorAndValue(fieldName, fieldName2, value, null, "=", ConfigFieldType.DROP_DOWN, columnIndex, columnIndex2, cellVals, cellVals2);
        userFilterHelper.checkFilterAttributeAndOperatorAndValue(fieldName, fieldName2, value, null, "<>", ConfigFieldType.DROP_DOWN, columnIndex, columnIndex2, cellVals, cellVals2);
        userFilterHelper.checkFilterAttributeAndOperatorAndValue(fieldName, fieldName2, value, null, "Is Null", ConfigFieldType.DROP_DOWN, columnIndex, columnIndex2, cellVals, cellVals2);
        userFilterHelper.checkFilterAttributeAndOperatorAndValue(fieldName, fieldName2, value, null, "Is Not Null", ConfigFieldType.DROP_DOWN, columnIndex, columnIndex2, cellVals, cellVals2);

        if (supportFieldOperations) {
            userFilterHelper.checkFilterAttributeAndOperatorAndValue(fieldName, fieldName2, value, null, "=Field", ConfigFieldType.DROP_DOWN, columnIndex, columnIndex2, cellVals, cellVals2);
            userFilterHelper.checkFilterAttributeAndOperatorAndValue(fieldName, fieldName2, value, null, "<>Field", ConfigFieldType.DROP_DOWN, columnIndex, columnIndex2, cellVals, cellVals2);
        }

        if (supportOuterOperations) {
            userFilterHelper.checkFilterAttributeAndOperatorAndValue(fieldName, fieldName2, value, null, "(+)=", ConfigFieldType.DROP_DOWN, columnIndex, columnIndex2, cellVals, cellVals2, cellValsKeys);
            userFilterHelper.checkFilterAttributeAndOperatorAndValue(fieldName, fieldName2, value, null, "(+)<>", ConfigFieldType.DROP_DOWN, columnIndex, columnIndex2, cellVals, cellVals2, cellValsKeys);
        }
    }
